      ...
      <section className="relative overflow-hidden rounded-2xl border border-zinc-300 p-4 md:p-6">
        ...
        <div className="relative space-y-4">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              <h2 className="text-lg font-semibold tracking-tight">Live Flight Pulse (DXB/AUH)</h2>
              <p className="text-sm text-zinc-700">Real-time pulse from Flightradar API snapshots for active disruption triage.</p>
            </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <article className="rounded-xl border border-zinc-300 bg-white/80 p-3">
              <p className="text-xs uppercase tracking-wide text-zinc-600">Tracked Flights</p>
